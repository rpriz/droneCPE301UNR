...
void setup(){
  ...
  DDRD |= B11000011;                                                        //Configure digital poort 4, 5, 6 and 7 as output.
...
void loop(){
  ...
  PORTA |= B11000011 ;                                                       //Set digital outputs 4,5,6 and 7 high.
  ...
  while(PORTA >= 16){                                                       //Stay in this loop until output 4,5,6 and 7 are low.
    ...
    if(timer_channel_1 <= esc_loop_timer)PORTA &= B00111100 ;                //Set digital output 4 to low if the time is expired.
    if(timer_channel_2 <= esc_loop_timer)PORTA &= B00111100 ;                //Set digital output 5 to low if the time is expired.
    if(timer_channel_3 <= esc_loop_timer)PORTA &= B00111100 ;                //Set digital output 6 to low if the time is expired.
    if(timer_channel_4 <= esc_loop_timer)PORTA &= B00111100 ;                //Set digital output 7 to low if the time is expired.
  }
}
